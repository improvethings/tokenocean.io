    ...
    function create_fragment$1(ctx) {
    	...
    	return {
    		c() {
              ...
              <p class="mt-4 text-lg text-blueGray-200">We are a <span class="text-brightgreen">white label</span>
                ...
                <p class="mt-2 mb-4 text-blueGray-500">We leverage the Liquid Network, a bitcoin layer-2 solution to
                  ...
                  blockchain. All of our code is fully auditable.</p></div></div></div> 
          ...
          <div class="w-full md:w-4/12 px-4 text-center"><div class="relative flex flex-col min-w-0 break-words bg-white w-full mb-8 shadow-lg rounded-lg"><div class="px-4 py-5 flex-auto"><div class="text-white p-3 text-center inline-flex items-center justify-center w-12 h-12 mb-5 shadow-lg rounded-full bg-secondary"><i class="fas fa-toolbox"></i></div> 
                ...
                <p class="mt-2 mb-4 text-blueGray-500">We offer a full suite of development services making it
                  possible to realize your vision and provide ongoing
                  maintenance if requested.</p></div></div></div> 
          ...
          <div class="pt-6 w-full md:w-4/12 px-4 text-center"><div class="relative flex flex-col min-w-0 break-words bg-white w-full mb-8 shadow-lg rounded-lg"><div class="px-4 py-5 flex-auto"><div class="text-white p-3 text-center inline-flex items-center justify-center w-12 h-12 mb-5 shadow-lg rounded-full bg-secondary"><i class="fas fa-chalkboard-teacher"></i></div> 
    			...
    			div21.innerHTML = `<div class="text-white p-3 text-center inline-flex items-center justify-center w-16 h-16 mb-6 shadow-lg rounded-full bg-secondary"><i class="fas fa-user-friends text-xl"></i></div> 
            ...
            <p class="text-lg leading-relaxed m-4 text-blueGray-500">Kris Constable - the co-founder of tokenocean.io, founded the 
        ...
        <div class="flex flex-wrap mt-12 justify-center"><div class="w-full lg:w-3/12 px-4 text-center"><div class="text-blueGray-800 p-3 w-12 h-12 shadow-lg rounded-full bg-brightgreen inline-flex items-center justify-center"><i class="fas fa-dollar-sign text-xl"></i></div> 
          ...
          <div class="w-full lg:w-3/12 px-4 text-center"><div class="text-blueGray-800 p-3 w-12 h-12 shadow-lg rounded-full bg-brightgreen inline-flex items-center justify-center"><i class="fas fa-hands-helping text-xl"></i></div> 
            ...
            <p class="mt-2 mb-20 text-blueGray-400">We iterate with you to create the best possible product.</p></div></div></div>`;
    			...
    			t99 = space();
    			p12 = element("p");
    			p12.textContent = "We're excited to work with you! Please describe briefly your\n                    bitcoin NFT idea or project so we may provide a specific and\n                    timely reply to your inquiry.";
    			t101 = space();
    			div63 = element("div");

    			div63.innerHTML = `<label class="block uppercase text-blueGray-600 text-xs font-bold mb-2" for="full-name">Name *</label> 
                    <input id="full-name" type="text" required="" class="border-0 px-3 py-3 placeholder-blueGray-300 text-blueGray-600 bg-white rounded text-sm shadow focus:outline-none focus:ring w-full ease-linear transition-all duration-150" placeholder="Full Name" name="full-name"/>`;

    			t104 = space();
    			div64 = element("div");

    			div64.innerHTML = `<label class="block uppercase text-blueGray-600 text-xs font-bold mb-2" for="email">Email *</label> 
                    <input id="email" type="email" required="" class="border-0 px-3 py-3 placeholder-blueGray-300 text-blueGray-600 bg-white rounded text-sm shadow focus:outline-none focus:ring w-full ease-linear transition-all duration-150" placeholder="Email Address" name="email"/>`;

    			t107 = space();
    			div65 = element("div");

    			div65.innerHTML = `<label class="block uppercase text-blueGray-600 text-xs font-bold mb-2" for="phone">Phone</label> 
                    <input id="phone" type="tel" class="border-0 px-3 py-3 placeholder-blueGray-300 text-blueGray-600 bg-white rounded text-sm shadow focus:outline-none focus:ring w-full ease-linear transition-all duration-150" placeholder="Phone Number" name="phone"/>`;

    			t110 = space();
    			div66 = element("div");

    			div66.innerHTML = `<label class="block uppercase text-blueGray-600 text-xs font-bold mb-2" for="company">Company</label> 
                    <input id="company" type="text" class="border-0 px-3 py-3 placeholder-blueGray-300 text-blueGray-600 bg-white rounded text-sm shadow focus:outline-none focus:ring w-full ease-linear transition-all duration-150" placeholder="Company Name" name="company"/>`;
    			...
    			div68.innerHTML = `<label class="block uppercase text-blueGray-600 text-xs font-bold mb-2" for="message">Message *</label> 
                    <textarea id="message" rows="4" required="" cols="80" class="border-0 px-3 py-3 placeholder-blueGray-300 text-blueGray-600 bg-white rounded text-sm shadow focus:outline-none focus:ring w-full" placeholder="Type a message..." name="message"></textarea>`;

    			t124 = space();
    			div69 = element("div");
    			div69.innerHTML = `<button class="bg-secondary text-white active:bg-blueGray-600 text-sm font-bold uppercase px-6 py-3 rounded shadow hover:shadow-lg outline-none focus:outline-none mr-1 mb-1 ease-linear transition-all duration-150" type="submit">Send Message</button>`;
    			t126 = space();
    			...
    			attr(div42, "class", "block lg:flex justify-center items-center space-y-20 px-4 lg:space-y-0 lg:space-x-10 xl:space-x-20");
    			...
    			attr(div50, "class", "flex justify-center items-center flex-wrap");
    			attr(div51, "class", "container mx-auto px-4");
    			...
    			attr(p12, "class", "leading-relaxed mt-1 mb-4 text-blueGray-500");
    			attr(div63, "class", "relative w-full mb-3 mt-8");
    			attr(div64, "class", "relative w-full mb-3");
    			attr(div65, "class", "relative w-full mb-3");
    			attr(div66, "class", "relative w-full mb-3");
    			...
    			attr(div67, "class", "relative w-full mb-3");
    			attr(div68, "class", "relative w-full mb-3");
    			attr(div69, "class", "text-center mt-6");
    			attr(div70, "class", "flex-auto p-5 lg:p-10");
    			attr(div70, "id", "book");
    			attr(div71, "class", "relative flex flex-col min-w-0 break-words w-full mb-6 shadow-lg rounded-lg bg-blueGray-200");
    			attr(form, "action", "https://formspree.io/f/xwkybjvp");
    			attr(form, "method", "POST");
    			attr(div72, "class", "w-full lg:w-6/12 px-4");
    			attr(div73, "class", "flex flex-wrap justify-center lg:-mt-64 -mt-48");
    			attr(div74, "class", "container mx-auto px-4");
    			attr(section5, "class", "relative block py-24 bg-primary");
    		},
    		m(target, anchor) {
    			insert(target, div75, anchor);
    			mount_component(authnavbar, div75, null);
    			append(div75, t0);
    			append(div75, main);
    			append(main, div6);
    			append(div6, div0);
    			...
    			append(div70, div69);
    			append(div75, t126);
    			mount_component(footer, div75, null);
    			current = true;
    		},
    		p: noop,
    		i(local) {
